			...
			<div class="container">
				...
				<div class="service-counter text-center">
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<img src="{{'/frontend/'}}assets/images/service/s1.png" alt="service-icon" />
							</div><!--/.service-img-->
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="service-img">
								<img src="{{'/frontend/'}}assets/images/service/s2.png" alt="service-icon" />
							</div><!--/.service-img-->
							<div class="service-content">
								<h2>
									<a href="#">
					...
					<div class="col-md-4 col-sm-4">
						<div class="single-service-box">
							<div class="statistics-img">
								<img src="{{'/frontend/'}}assets/images/service/s3.png" alt="service-icon" />
							</div><!--/.service-img-->
							<div class="service-content">
						...
						<div class="col-sm-4">
							<div class="single-special-offer">
								<div class="single-special-offer-bg">
									<img src="{{'/frontend/'}}assets/images/offer/offer-shape.png" alt="offer-shape">
							...
							<div class="row">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										...
										<div class="thumbnail-img">
											<img src="{{'/frontend/'}}assets/images/blog/b1.jpg" alt="blog-img">
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2017</span></h2>
										<div class="thumbnail-img">
											<img src="{{'/frontend/'}}assets/images/blog/b2.jpg" alt="blog-img">
											<div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
								...
								<div class="col-sm-4 col-md-4">
									<div class="thumbnail">
										<h2>trending news <span>15 november 2017</span></h2>
										<div class="thumbnail-img">
											<img src="{{'/frontend/'}}assets/images/blog/b3.jpg" alt="blog-img">
											<div class="thumbnail-img-overlay"></div><!--/.thumbnail-img-overlay-->
